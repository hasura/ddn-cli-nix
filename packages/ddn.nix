...
let
  ...
  hash = system: {
    "linux-amd64" = "sha256-dyTZoiHkFkv+x2iIs3A/j6Jqm94rnsEU5uHHRkiYqNM=";
    "darwin-amd64" = "sha256-mpzPoXJNg6YhnFImYvN7CdDwaDETuDbDQfZKae5PkP8=";
    "darwin-arm64" = "sha256-MZwsaBB7XVIWk0bmQSl0Yf6FkRxFZeJjLA36LdGK2ls=";
  }.${system};
  src = system: fetchurl {
