...
let
  ...
  hash = system: {
    "linux-amd64" = "sha256-We7+OfojJBGl5xJtn0KuYvYWGsUNga5ivdkcBq4IxAg=";
    "darwin-amd64" = "sha256-f/1yYSvtCKG/Dg3HHFgbZiTdNqYwcXdp5TzMTVWILxY=";
    "darwin-arm64" = "sha256-gz9HKwZrXMnmmRrcY2AkiUMDz0OIr+bWbCqEs+Hwi/g=";
  }.${system};
  src = system: fetchurl {
