...
let
  ...
  hash = system: {
    "linux-amd64" = "sha256-gSEymSMjyL5RYh/BnHfG4qG+2z/97ROfYlxY5RT91BM=";
    "darwin-amd64" = "sha256-+NnZxH5j09te8bcgf3Kig4NzdMci0pYRhcHy0Ia/s0s=";
    "darwin-arm64" = "sha256-qMOTGEe9Mh4hLcSEaKFF+X/Ld5Md9xWFSbbYhVljYQc=";
  }.${system};
  src = system: fetchurl {
