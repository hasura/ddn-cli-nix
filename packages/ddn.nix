...
let
  ...
  hash = system: {
    "linux-amd64" = "sha256-k9za7GmulIqPpf4gRo/hYt00XrzhAHAnNNFM58JSuGs=";
    "darwin-amd64" = "sha256-kcVe5hsa5VDYEo9KuGeeU9JG2iRwExVwDuLHMQCB9Vw=";
    "darwin-arm64" = "sha256-arkIpe8HkKwIPyDQE0BFvkxaw1KJRXf5kyhiKC4DeMk=";
  }.${system};
  src = system: fetchurl {
